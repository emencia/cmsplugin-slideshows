...
from cmsplugin_slideshows.models import SlideshowPlugin as SlideshowPluginModel
from cmsplugin_slideshows.models import SlideshowRandomImagePlugin as SlideshowRandomImagePluginModel
